...
6.  To show how we can expose enterprise applications as APIs, you can open up the App Connect Project located on your demo VM in the `c:\labs` directory.  The Project is called `3_CIforSFDemo-API`
